...
const CryptoDetails = () => {
    ...
    const genericStats = [
        ...
        { title: "Aprroved Supply", value: cryptoDetails?.supply?.confirmed ? <Icon as={AiOutlineCheckCircle} /> : <Icon as={AiOutlineStop} /> , icon: AiOutlineExclamationCircle },
    ...
    if (isFetching) return <Center w="100%" h="90vh"><Spinner size={"xl"} color="#0078ff"/></Center>;
